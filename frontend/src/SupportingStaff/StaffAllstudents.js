                ...
                <div className="b2">
                    <ul>
                        ...
                        <div>
                            ...
                            <button className="btn btn-outline-dark ms-1" onClick={(e) => { handleClick(e); doc.save('All Students.pdf') }}>Download pdf</button>
                        </div>
                    </ul>
                </div>
            </div>
...
export default StaffAllStudents;