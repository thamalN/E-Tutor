                            ...
                            <table className="table table2 text-center">
                                ...
                                {data.map((payment, i) => (
                                    <div>
                                            ...
                                            <td>{payment.month}</td>
                                            <td><button className="btn btn-dark" onClick={(e) => setPaymentdata({ ...paymentdata, payment_id: payment.payment_id, student_id: payment.student_id, course_id: payment.course_id})} data-bs-toggle="modal" data-bs-target="#exampleModal1">View</button></td>
                                            </tr>
